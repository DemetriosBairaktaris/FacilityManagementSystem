...
public class ConcreteFacilityManager implements FacilityManager {
  ...
  public void addNewFacility(String name, String description, String address) {
    ...
    building.setMaintenance((Maintenance) context.getBean("maintenance"));
    building.log();
  ...
  public List<MaintenanceRequest> listMaintRequests() {
    return currentFacility.getMaintenance().listMaintRequests();
  }

  @Override
  public List<Order> listMaintenance() {
    return currentFacility.getMaintenance().listMaintenance();
  }
